 ...
 * - movies: Array of Movie objects (memoized to prevent unnecessary re-renders)
 ...
 */
export const useMoviesOptimized = () => {
    ...
    if (!context) {
        throw new Error('useMoviesOptimized must be used within a DittoProvider');
    }
